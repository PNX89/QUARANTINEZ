...
WHY THIS EXISTS. The card at pnx89.github.io/QUARANTINEZ shows the output of a real run and four
...
DEMO = ["uv", "run", "python", "examples/venue_session.py"]
...
def main() -> int:
    ...
    repo_slug = os.environ.get("GITHUB_REPOSITORY", "PNX89/QUARANTINEZ")
    facts = {
        "tests": test_total(),
        "python": python_range(),
        "release": release(),
