...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_readme_shows_one_transcript_line_per_declared_misbehaviour",
    "COMMAND": "test_every_command_the_readme_shows_is_one_this_repository_runs",
    "OUTPUT": "test_the_readme_transcript_lines_are_in_the_captured_run",
...
def _resolves(claim: str) -> bool:
    ...
    `quarantinez/thing.py` because that is the import path a reader types, and the file is at
    `src/quarantinez/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
